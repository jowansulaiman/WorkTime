...
class FirestoreService {
  ...
  /// Bucht eine Bestandsaenderung atomar: aktualisiert den Artikelbestand und
  /// schreibt eine Bestandsbewegung in einer Transaktion.
  ///
  /// [delta] ist die Mengenaenderung (positiv = Zugang). Gibt den neuen
  /// Bestand zurueck.
  ...
  ///
  /// [receivedByItemIndex] bildet den Positionsindex auf die jetzt zusaetzlich
  /// gelieferte Menge ab. Aktualisiert die gelieferten Mengen der Bestellung,
  /// erhoeht die Artikelbestaende, schreibt Bestandsbewegungen und leitet den
  /// neuen Bestellstatus ab – alles in einer Transaktion.
