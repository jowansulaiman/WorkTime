...
**OFFEN (alle GROSS/riskant/blockiert):** PA-5 (Festschreibung, Stempel-Bereich — Nutzer editiert parallel) · PA-4 (Stempel-Härtung `{userId}-open` — Nutzer editiert parallel) · PA-6.2 (Lines-Verrechnung in Bemessung — komplexe Steuer/SV, „Fable 5") · PA-6.3-DATEV (Bewegungsdaten-Export) · PA-7.3-Offboarding/Autoplan (scheduling-gekoppelt) · PA-8.1-Löschworkflow · PA-2.1/2.2 (Akte-URL-Refactor aus 5.649-Zeilen-Datei) · PA-1.1/1.2 (migrations-gated) · PA-9 (Deploy, Blaze).
